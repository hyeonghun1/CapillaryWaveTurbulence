...
This repository contains the codebase for the work "Stochastic reduced-order modeling of capillary wave turbulence via
Operator Inference using experimental measurements." 
